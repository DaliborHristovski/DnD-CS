...
public class BaseStats extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Strength, Dexterity, Constitution, Intellect, and Wisdom");

        jLabel3.setFont(new java.awt.Font("MV Boli", 0, 14)); // NOI18N
        jLabel3.setText("You can roll 4 6-sided die and record the cumulative ");

        jLabel2.setFont(new java.awt.Font("MV Boli", 0, 14)); // NOI18N
        jLabel2.setText("You have 6 Ability scores to roll for:");
        ...
        jLabel4.setText("Or take the “standard set” which is 15,14,13,12,10,8. ");

        jButton2.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        jButton2.setText("Take Standard");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BaseStats.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
